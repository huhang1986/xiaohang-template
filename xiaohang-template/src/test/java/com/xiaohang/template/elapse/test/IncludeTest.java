...
public class IncludeTest {
	...
	private static TemplateManager templateManager = new ConcurrentTemplateManager();

	public static void main(String[] args) {

		addTemplate("foreach_test", "template/elapse/foreach_test.html");
		addTemplate("include_test", "template/elapse/include_test.html");

		Template template = templateManager.getTemplate("include_test");
	...
	protected static void addTemplate(String name, String path) {
		InputStream inputStream = Thread.currentThread()
				.getContextClassLoader().getResourceAsStream(path);

		TemplateEngine templateEngine = new ElapseTemplateEngine();
		Template template = templateEngine.createTemplate(inputStream, "GBK");
